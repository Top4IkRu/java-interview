...
11. Расскажите подробно, как работает метод put?
...
16. Что такое синхронизированные (`synchronized`) коллекции? Какие есть синхронизированные реализации в Java?
17. Как можно сортировать элементы в коллекциях? Какой интерфейс следует использовать для сортировки?
...
называется коллизия), то в корзине образуется связааный список (linked list) и мы идем по этому списку и проверяем есть
