...
16. С какого числа начинается индекс массива?
17. Какая максимальная длина массива? Существуют ли многомерные массивы в java? Как создать многомерный массив?
18. Что такое метод и чем отличается от функции, возвращаемое значение, аргументы метода?
19. Что такое инкремент и декремент?
20. Чем отличаются постфиксная и префиксная форма?
21. Какие есть логические операции?
22. Таблица истинности XOR.
23. А если подряд три true XOR true XOR true какой результат?
24. Расскажи про все условные операторы?
25. Как записывается тернарный оператор? Что пишется в начале тернарного оператора и что идет дальше?
26. Можно ли в switch case использовать String, Enum?
27. Какие есть циклы в Java? Чем отличаются друг от друга? (пост условие пред условие)
28. Что такое continue и break? Почему не рекомендуется их использовать?
29. Если в case не поставить break что будет?
30. Что такое рекурсия? Недостатки и преимущества?
31. 2 условия выхода из рекурсивного алгоритма?
32. Зачем нужны BigInteger и BigDecimal?
